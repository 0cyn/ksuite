...
class DSCSidebarWidgetType : public SidebarWidgetType, public SidebarWidgetTypeExtended {
public:
    DSCSidebarWidgetType();

    bool ValidForView(BinaryNinja::BinaryView* view) override
    {
        if (!view)
            return false;
        return (view->GetTypeName() == "DSCView");
    }
